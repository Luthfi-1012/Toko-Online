...
@section('content')
    ...
    <div class="modern-hero-section">
        <div class="modern-hero-badge">
            <i class="fa fa-fire"></i> Rekomendasi Spesial Hari Ini
        </div>
        <h1 class="modern-hero-title">
            Nikmati Kelezatan Jajanan<br>Tradisional Khas Nusantara
        </h1>
        <p class="modern-hero-desc">
            Pilihan aneka kue, cemilan beku, dan minuman tradisional yang diolah higienis dengan resep warisan asli Indonesia.
        </p>
        <a href="{{ route('produk.all') }}" class="hero-cta-btn">
            <span>Jelajahi Semua Menu</span>
            <i class="fa fa-arrow-right"></i>
        </a>
    </div>

    <!-- CATALOG HEADER & STORE -->
    <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 20px; flex-wrap: wrap; gap: 10px;">
        <div>
            <h3 style="font-size: 22px; font-weight: 800; margin: 0; color: var(--text-main);">Daftar Menu Pilihan</h3>
            <p style="font-size: 13.5px; color: var(--text-muted); margin: 0;">Temukan cemilan dan makanan favoritmu di bawah ini</p>
        </div>
        <div>
            <span class="badge-modern" style="background: var(--primary-light); color: var(--primary); font-size: 13px; padding: 6px 14px;">
                <i class="fa fa-check-circle"></i> {{ $produk->total() }} Produk Tersedia
            </span>
        </div>
    </div>
